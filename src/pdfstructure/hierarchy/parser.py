...
from src.pdfstructure.analysis.annotate import StyleAnnotator
from src.pdfstructure.analysis.sizemapper import PivotLogMapper
from src.pdfstructure.analysis.styledistribution import count_sizes, StyleDistribution
from src.pdfstructure.hierarchy.detectheader import header_detector
from src.pdfstructure.hierarchy.headercompare import get_default_sub_header_conditions
from src.pdfstructure.model.document import TextElement, Section, StructuredPdfDocument, DanglingTextSection
from src.pdfstructure.source import Source
...
class HierarchyParser:
    ...
    @staticmethod
    def __should_pop_higher_level(stack: List[Section], header_to_test: Section):
        """
    ...
    @staticmethod
    def __top_has_no_header(stack: List[Section]):
        """
