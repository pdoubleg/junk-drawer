...
def run(
    ...
    assigner_for_proposed_descriptions_template: str = "templates/gpt_assigner.txt",
    assigner_for_final_assignment_template: str = "templates/gpt_multi_assigner_one_output.txt",
    # clusterer arguments
    cluster_algo: str = "maximum_set_coverage",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--proposer_num_descriptions_to_propose", type=int, default=10)
    parser.add_argument("--proposer_num_rounds_to_propose", type=int, default=None)
    parser.add_argument("--proposer_num_descriptions_per_round", type=int, default=5)
    parser.add_argument(
        "--proposer_template",
        type=str,
    ...
    parser.add_argument("--assigner_name", type=str, default="gpt-3.5-turbo")
    parser.add_argument(
        "--assigner_for_proposed_descriptions_template",
        type=str,
        default="templates/gpt_assigner.txt",
    )
    parser.add_argument(
    ...
    parser.add_argument("--iterative_max_rounds", type=int, default=2)
